...
The human microbiota is often times more complex than trying to understand the 
The purpose of the study, Fierer et al. (2010) was to investigate a  method to forensically identify indiviuals through their unique skin-associated bacterial colonies. 
...
3. Lifestyle choices and personal hygeine can be inferred from the human samples where certain bacteria known to be pathogenic reside. 
...
3.) Why some Genera are highly abundant in a specific sample (Is it in relation to the sample that it comes from, whether that sample is human, male, female etc.)
