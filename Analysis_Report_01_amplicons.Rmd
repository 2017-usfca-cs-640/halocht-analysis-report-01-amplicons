...
**Figure 8 Description**: Actinobacteria is the first Phyla that is relatively well distributed across all samples except for two human ones (ERR1942285-female and ERR1942295- male). Furthermore the composition of ERR1942281,ERR1942283 and ERR1942294 are more similar to each other than the rest of the other samples (ERR1942281 and ERR1942283 are female samples while ERR1942294 is a computer mouse sample). These sequences have a greater degree of identification i  
