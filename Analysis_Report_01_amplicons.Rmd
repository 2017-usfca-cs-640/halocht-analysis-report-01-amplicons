...
PS2 = ps2
wh0 = genefilter_sample(PS2, filterfun_sample(function(x) x > 5), A=0.5*nsamples(PS2))
PS2_pruned = prune_taxa(wh0, PS2)

```

OTU.ord <- ordinate(ps2, method="NMDS", distance="bray")
```
